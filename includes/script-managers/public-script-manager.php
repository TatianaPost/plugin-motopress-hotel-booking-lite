...
class PublicScriptManager extends ScriptManager {
	...
	public function __construct(){
        ...
        add_action( 'enqueue_block_editor_assets', array( $this, 'registerRoomTypesForBlockEditor' ) );
        add_action( 'enqueue_block_editor_assets', array( $this, 'enqueueEditor' ) );
    ...
    public function registerRoomTypesForBlockEditor()
    {
